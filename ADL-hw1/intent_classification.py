...
def main():
    ...
    if training_args.do_train:
        ...
        label_list = raw_datasets["validation"].unique("intent")
    else:
        if data_args.train_file is not None:
            label_list = raw_datasets_foridx["train"].unique("intent")
        if data_args.validation_file is not None:
            label_list = raw_datasets_foridx["validation"].unique("intent")
    ...
    # TODO: our own data collator? or from bert?
    if data_args.pad_to_max_length:
